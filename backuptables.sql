...
INSERT INTO `projectinfo` VALUES (1,'fil','lab','good','class','2013-12-29','2013-12-29',2000,'good'),(210,'ooad','fil','processing','good','2014-12-22','2014-12-30',100,NULL),(999,'ooad1','water','good','yes','2013-12-12','2015-12-12',2000,NULL);
...
INSERT INTO `taskinfo` VALUES (1,210,'2014-12-01','2014-12-12',NULL,NULL),(2,1,'2014-11-11','2014-10-10','abc','diags'),(3,210,'2014-11-11','2014-10-10','abc','design');
...
CREATE TABLE `userrecord` (
  ...
  PRIMARY KEY (`user_name`),
  KEY `project_ID` (`project_ID`),
  CONSTRAINT `userrecord_ibfk_3` FOREIGN KEY (`project_ID`) REFERENCES `projectinfo` (`project_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userrecord` VALUES ('abc','123','stu','abc@',12252435,NULL),('abc1','1232','stu','abc1@',12252435,NULL),('abc2','12322','stu','abc2@',12252435,NULL),('abc3','212322','stu','abc3@',12252435,NULL),('chaitu','12kod','student','srutiksl@yahoo.in',312345,NULL),('clara','12345','stu','gmail',98,NULL),('college','456ft','stu','try@gmail.com',5678,NULL),('engg','456ft','stu','try@gmail.com',5678,NULL),('sai',NULL,'manager',NULL,0,NULL),('santa','12345','stu','gmail',98,NULL),('satya',NULL,'prof',NULL,0,NULL),('sru','123koi','student','skoduri@scu.edu',315,NULL),('sruti','123koi','student','soduri@scu.edu',315,NULL),('srutiksl','123koduri','student','skoduri@scu.edu',314,NULL),('stanley','456ft','stu','try@gmail.com',5678,NULL),('tech','456ft','stu','try@gmail.com',5678,NULL),('university','12345','stu','gmail',98,NULL),('vam','1233','prof','vam@gamail',4268,NULL);
...
-- Dump completed on 2014-12-03  1:10:36
